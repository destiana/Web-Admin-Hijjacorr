...
* @param integer $id_verif_gambar
*
* @return mixed
*/
public function actionView($id_verif_gambar)
{
...
'model' => $this->findModel($id_verif_gambar),
]);
}
...
return $this->redirect(['view', 'id_verif_gambar' => $model->id_verif_gambar]);
...
* @return mixed
*/
public function actionUpdate($id_verif_gambar)
{
$model = $this->findModel($id_verif_gambar);
...
* @return mixed
*/
public function actionDelete($id_verif_gambar)
{
try {
$this->findModel($id_verif_gambar)->delete();
} catch (\Exception $e) {
$msg = (isset($e->errorInfo[2]))?$e->errorInfo[2]:$e->getMessage();
...
$isPivot = strstr('$id_verif_gambar',',');
if ($isPivot == true) {
return $this->redirect(Url::previous());
...
*/
protected function findModel($id_verif_gambar)
{
if (($model = VerifGambar::findOne($id_verif_gambar)) !== null) {
return $model;
} else {
